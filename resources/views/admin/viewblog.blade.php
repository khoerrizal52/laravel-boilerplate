...
@section('title', __('views.admin.viewblog.title'))
...
@section('content')
    <div class="row">
        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
            ...
            <thead>
            <tr>
                <th>@sortablelink('title', __('views.admin.viewblog.table_header_0'),['page' => $blogs->currentPage()])</th>
                <th style="width: 50%">@sortablelink('content',  __('views.admin.viewblog.table_header_1'),['page' => $blogs->currentPage()])</th>
                <th>@sortablelink('created_at', __('views.admin.viewblog.table_header_2'),['page' => $blogs->currentPage()])</th>
                <th>@sortablelink('updated_at', __('views.admin.viewblog.table_header_3'),['page' => $blogs->currentPage()])</th>
                <th>Actions</th>
            </tr>
            </thead>
            <tbody>
